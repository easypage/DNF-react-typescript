...
function AuctionSearchForm() {
  ...
  return (
    <div className="w-AuctionSearchForm h-14 flex items-center justify-center border-4 border-yellow-300 border-solid rounded-full shadow-md mt-common m-auto ">
      <img src={searchImage} alt="" className="w-[35px] h-[35px] mr-7" />
      <input type="search" className="w-[550px] h-12 outline-0 flex justify-start" onChange={onChange} onKeyPress={handleKeyPress} value={auctionItemName} placeholder="아이템을 입력해 주세요." />
